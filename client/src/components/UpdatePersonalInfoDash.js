...
export default class UpdatePersonalInfoDash extends Component{
    constructor(props){
        super(props);
        ...
        axios.get('http://localhost:5000/patientInfo/')
            .then(response => {
               ...
               // const word = this.state.patients.filter(his => his._id === id);
                ...
                this.setState({
                    words: this.state.patients.filter(his => his._id === id)
                });
           })
           .catch((err) => {
               console.log(err);
            ...
            <div>
                <div className="row">
                    <div className="col-md-4 mx-auto">
                            ...
                            <Link to={"/viewInfoDash" + this.props.match.params.id} className="nav-link">
                                back
                            </Link>
